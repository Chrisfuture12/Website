						...
						<div id="mainFeedBig" class= "mainFeedBig">
							<div class="mfbSmall">
													...
													<a id="libOptPP" class="select"> 
														<div id="input" class="input" name="Privacy">
															...
															<div id="libOptPP2" class="select-options">
																<ul class="libOptPP3"> 
																	<li>
																		<span><input type="radio" value="Public" id="pub" name="privacy"/>
																		<label for="pub">Public</label></span>
																	</li>
																	<li class="selected">
																		<span><input type="radio" value="Private" id="priv" name="privacy" checked/>
																		<label for="priv">Private</label></span>
																	</li>
																</ul>
															</div>
													</a>
								...
								<div id="All-list-show" class="libOptALS">
									<div id="CLDshow" class="libOpt libOpt-D">
										 <?php

                                         $sqlCL1 = "SELECT User_iD FROM library WHERE Email_Phone_Number='$Email_Phone_Number'";
                                                    
											$sqlCL = "SELECT * FROM library LIMIT 3";
											$result = mysqli_query($db, $sqlCL);
											if (mysqli_num_rows($result) > 0) {									
												while ($row = mysqli_fetch_assoc($result)) {	
												echo "<div class=\"CLDbox\">";
													echo "<h3>";
														echo $row['Title'];
														echo "<br>";
														echo $row['Privacy'];
									...
									<div id="SPLshow" class="libOpt libOpt-D">
										<h3>(insert saved profiles from database)</h3>
									</div>
									<div id="LPDshow" class="libOpt libOpt-D">
